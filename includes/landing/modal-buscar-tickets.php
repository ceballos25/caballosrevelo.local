        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-bold" id="modalBuscarTicketsLabel">🔍 Buscar mis nums</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body pt-2">
                    <p class="text-muted small text-center mb-3 px-1">
                        Ingresa el <strong>número de celular con el que realizaste la compra</strong>.                        
                    </p>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-1 mb-3">
                        <span id="buscarTicketsHint" class="form-text mb-0">Solo números, sin espacios ni guiones</span>
