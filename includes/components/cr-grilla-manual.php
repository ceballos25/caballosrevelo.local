...
<div class="<?= htmlspecialchars($crGrillaWrapperClass, ENT_QUOTES, 'UTF-8') ?> cr-grilla-panel" id="<?= htmlspecialchars($crGrillaWrapperId, ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="cr-grilla-panel__head">
        <div class="d-flex justify-content-between align-items-center gap-2">
            <p class="cr-grilla-panel__title mb-0">Elige tus números</p>
    ...
    <div id="<?= htmlspecialchars($crGrillaGridId, ENT_QUOTES, 'UTF-8') ?>" class="cr-grilla-numeros cr-grilla-numeros--grid" role="listbox" aria-label="Números de la rifa"></div>
