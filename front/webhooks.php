                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-2">
                            ...
                            <strong>accesorios.caballosrevelo.com</strong>):
                        ...
                        <p class="text-muted small mb-3">
                            ...
                            <strong>charge.failed</strong> / <strong>charge.cancelled</strong> / <strong>charge.refunded</strong> (rechazan y liberan números).
                        </p>
