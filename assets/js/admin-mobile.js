...
function crNumeroChipInlineStyle(variant = 'selected', large = false) {
    ...
    const palettes = {
        selected: { backgroundColor: '#ffc107', color: '#0D0D0D', border: '2px solid #e0aa00' },
        libre: { backgroundColor: '#ffffff', color: '#0D0D0D', border: '2px solid #c8870a' },
        vendido: { backgroundColor: '#eeeeee', color: '#888888', border: '2px solid #cccccc' },
        reservado: { backgroundColor: '#ffffff', color: '#e0aa00', border: '2px dashed #ffc107' },
    };
...
function crNumeroChipVariantForStatus(status) {
...
function adminNumeroInventarioBadge(number, status) {
    const variant = crNumeroChipVariantForStatus(status);
