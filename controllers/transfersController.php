...
class TransfersController
{
    ...
    public static function crearTransferencia(array $data)
    {
        ...
        try {
            ...
            if (!$allocationService->isManualRaffle((int)$data['id_raffle'])) {
                ...
                return ['success' => false, 'message' => 'La cantidad no coincide con los números seleccionados'];
            }
        ...
        try {
            ...
            return ['success' => false, 'message' => 'No se pudieron reservar los números'];
        }
    ...
    public static function aprobarTransferencia(array $transfer)
    {
        ...
        if ($reservedIds === []) {
            ...
            return [
                'success' => false,
                'message' => 'Algunos números reservados ya no están disponibles. Rechace la solicitud para liberarlos o pida al cliente una nueva compra.',
            ];
        }
